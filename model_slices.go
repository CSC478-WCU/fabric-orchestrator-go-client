...
// checks if the Slices type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Slices{}

// Slices struct for Slices
type Slices struct {
...
func (o Slices) MarshalJSON() ([]byte, error) {
...
func (o Slices) ToMap() (map[string]interface{}, error) {
...
type NullableSlices struct {
	value *Slices
	isSet bool
}

func (v NullableSlices) Get() *Slices {
	return v.value
}

func (v *NullableSlices) Set(val *Slices) {
	v.value = val
	v.isSet = true
}

func (v NullableSlices) IsSet() bool {
	return v.isSet
}

func (v *NullableSlices) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlices(val *Slices) *NullableSlices {
	return &NullableSlices{value: val, isSet: true}
}

func (v NullableSlices) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlices) UnmarshalJSON(src []byte) error {
	v.isSet = true
