...
func (r ApiVersionGetRequest) Execute() (*Version, *http.Response, error) {
...
//  @return Version
func (a *VersionAPIService) VersionGetExecute(r ApiVersionGetRequest) (*Version, *http.Response, error) {
	var (
